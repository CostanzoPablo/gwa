...
if ($html["error"] == null){
	...
	if (isset($_POST["color_fuente_banner"])){
		...
		$general->actualizar($_POST["float_logo"], $_POST["color_fuente_banner"], $_POST["colorBotonHover"], $_POST["colorHr"], $_POST["facebook"], $_POST["twitter"], $_POST["youtube"], $_POST["fontFace"]);
	}
